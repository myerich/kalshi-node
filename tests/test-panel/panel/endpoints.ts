...
export const ENDPOINTS: EndpointDef[] = [
  ...
  },
  {
    ...
    method: "GET",
    endpoint: "/portfolio/orders/:orderId/queue_positions",
    auth: true,
    category: "Portfolio",
    pathParams: ["orderId"],
  },
  ...
  },
  {
    ...
    bodyParams: [
      ...
      { name: "yes_price_dollars", type: "string", required: false },
      { name: "no_price_dollars", type: "string", required: false },
  ...
  },
  {
    ...
    pathParams: ["orderId"],
    bodyParams: [
      { name: "reduce_by", type: "number", required: false },
      { name: "reduce_to", type: "number", required: false },
    ],
  },
