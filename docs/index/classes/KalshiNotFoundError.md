# Class: KalshiNotFoundError

Defined in: [errors.ts:16](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L16)
...
```ts
new KalshiNotFoundError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiNotFoundError;
```
