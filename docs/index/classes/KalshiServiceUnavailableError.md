# Class: KalshiServiceUnavailableError

Defined in: [errors.ts:31](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L31)
...
```ts
new KalshiServiceUnavailableError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiServiceUnavailableError;
```
