# Class: KalshiConflictError

Defined in: [errors.ts:17](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L17)
...
```ts
new KalshiConflictError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiConflictError;
```
