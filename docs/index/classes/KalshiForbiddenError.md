# Class: KalshiForbiddenError

Defined in: [errors.ts:15](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L15)
...
```ts
new KalshiForbiddenError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiForbiddenError;
```
