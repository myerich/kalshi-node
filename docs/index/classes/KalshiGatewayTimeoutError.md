# Class: KalshiGatewayTimeoutError

Defined in: [errors.ts:32](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L32)
...
```ts
new KalshiGatewayTimeoutError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiGatewayTimeoutError;
```
