# Class: KalshiBadRequestError

Defined in: [errors.ts:13](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L13)
...
```ts
new KalshiBadRequestError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiBadRequestError;
```
