# Class: KalshiServerError

Defined in: [errors.ts:30](https://github.com/myerich/kalshi-node/blob/3528ebe88544ddad32bb21f7dbb45582eeadfa49/src/errors.ts#L30)
...
```ts
new KalshiServerError(
   statusCode, 
   method, 
   endpoint, 
   responseBody): KalshiServerError;
```
